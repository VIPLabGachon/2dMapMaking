...
def HDBSCAN(input_pcd_path, output_pcd_path, min_cluster_size=130):
    """
...
height_output = '/tmp/converted_height.pcd'
hdbscan_output='/tmp/converted_hdb.pcd'
final_ouptut = '/tmp/converted_sor_final.pcd'
